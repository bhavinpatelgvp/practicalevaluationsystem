...
:root {
  ...
  --muted:#705d48;
  --accent:#8f5c32;
  --accent-strong:#5b381d;
  --border:#d8c3a5;
  --shadow:0 12px 30px rgba(62,49,34,0.08);
...
.stApp .block-container {
  padding-top:2rem; /* give extra space so top content isn't cut off */
}
...
.section-divider {
  ...
  background:linear-gradient(90deg, rgba(143,92,50,0), rgba(143,92,50,0.24), rgba(143,92,50,0));
}
.brand-header {
  display:flex;
  align-items:center;
...
.login-page {
  ...
  padding-top:1rem; /* ensure some breathing room from top */
  padding-bottom:0;
}
.login-page .stForm {
  width:100%;
...
button[kind="primary"] {
  ...
  box-shadow:0 8px 22px rgba(91,56,29,.18);
}
[data-testid="stSidebar"] .stButton>button,
[data-testid="stSidebar"] .stDownloadButton>button {
  background:linear-gradient(135deg, #f8efe3 0%, #ffffff 100%) !important;
  color:#4e2d16 !important;
  border:1px solid rgba(91,56,29,.28) !important;
  box-shadow:0 6px 16px rgba(255,255,255,.16);
  font-weight:700 !important;
}
[data-testid="stSidebar"] .stButton>button:hover,
[data-testid="stSidebar"] .stDownloadButton>button:hover {
  background:linear-gradient(135deg, #ffffff 0%, #f2e1c8 100%) !important;
  color:#4e2d16 !important;
}
...
.stSidebar .css-1lcbmhc.e16nr0p33 {
  padding:1rem 1rem 0.5rem;
}
.sidebar-panel {
  background:rgba(255,253,245,.94);
  border:1px solid rgba(143,92,50,.14);
  border-radius:18px;
  padding:1rem 1rem .8rem;
  margin-bottom:1rem;
  box-shadow:0 12px 24px rgba(62,49,34,0.08);
}
.sidebar-panel h3 {
  margin:0 0 .25rem;
  color:var(--ink);
...
.stTabs [role="tab"] {
  ...
  background:rgba(91,56,29,.08) !important;
  border:1px solid rgba(143,92,50,.12) !important;
...
.stExpanderHeader {
  background:rgba(91,56,29,.06) !important;
  border-radius:16px !important;
}
.login-card {
  background:var(--surface);
  border:1px solid rgba(143,92,50,.18);
  border-radius:16px;
  padding:1.1rem;
  max-width:420px;
  width:92%;
  margin:0.4rem 0 0 0; /* small top margin so header text isn't cut */
  box-shadow:0 8px 20px rgba(62,49,34,0.06);
}
.login-card h2 {
  margin-top:0;
...
.login-card .stDownloadButton>button {
  width:100% !important;
...
def render_footer() -> None:
    st.markdown(
        ...
        <div class="page-footer">
            <div>Designed for Department of Computer Science, Gujarat Vidyapith</div>
            <div>© 2026 Gujarat Vidyapith · Practical Evaluation System</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
